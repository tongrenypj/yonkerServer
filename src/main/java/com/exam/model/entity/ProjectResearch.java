 ...
 */
@Entity
public class ProjectResearch {

    @Id
    @GeneratedValue

    private Integer projectResearchId;
    ...
    public Integer getProjectResearchId() {
        return projectResearchId;
    }

    public void setProjectResearchId(Integer projectResearchId) {
        this.projectResearchId = projectResearchId;
    }
